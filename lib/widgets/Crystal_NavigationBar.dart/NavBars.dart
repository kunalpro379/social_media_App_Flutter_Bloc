...
import 'CN_Bar_Item.dart';
import 'body.dart';

enum BottomBarEnum { Home, Explore, Messages, Notifications, Profile }
...
class CrystalNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate the width based on the number of items and available screen width
                    ...
                    child: Padding(
                      ...
                      child: Body(
                          ...
                          itemPadding: EdgeInsets.symmetric(
                              vertical: 10,
                              horizontal:
                                  itemWidth / 8), // Adjust horizontal padding
        ...
        : Container(
            ...
            child: Padding(
              ...
              child: Body(
                  ...
                  itemPadding: EdgeInsets.symmetric(
                      vertical: 10,
                      horizontal: itemWidth / 6), // Adjust horizontal padding
                  indicatorColor: indicatorColor,
                  splashColor: splashColor,
                  splashBorderRadius: splashBorderRadius),
            ),
